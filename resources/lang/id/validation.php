...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Baris bahasa berikut ini berisi standar pesan kesalahan yang digunakan 
    | oleh kelas validasi. Beberapa aturan mempunyai multi versi seperti 
    | aturan 'size'. Jangan ragu untuk mengoptimalkan setiap pesan yang ada di | sini.
    |
    */

    'accepted' => 'Isian :attribute harus diterima.',
    'active_url' => 'Isian :attribute bukan URL yang valid.',
    'after' => 'Isian :attribute harus waktu setelah :date.',
    'after_or_equal' => 'Isian :attribute harus waktu setelah atau sama dengan waktu :date.',
    'alpha' => 'Isian :attribute hanya boleh berisi huruf.',
    'alpha_dash' => 'Isian :attribute hanya boleh berisi huruf, angka, dan strip.',
    'alpha_num' => 'Isian :attribute hanya boleh berisi huruf dan angka.',
    'array' => 'Isian :attribute harus berupa sebuah array.',
    'before' => 'Isian :attribute harus waktu sebelum :date.',
    ...
    'confirmed' => 'Isian :attribute harus sama dengan konfirmasi password.',
    ...
    'gt' => [
        'numeric' => 'Isian :attribute seharusnya lebih dari :value.',
        'file' => 'Isian :attribute seharusnya lebih dari :value kilobytes.',
        'string' => 'Isian :attribute seharusnya lebih dari :value karakter.',
        'array' => 'Isian :attribute seharusnya lebih dari :value item.',
    ],
    'gte' => [
        'numeric' => 'Isian :attribute seharusnya lebih dari atau sama dengan :value.',
        'file' => 'Isian :attribute seharusnya lebih dari atau sama dengan :value kilobytes.',
        'string' => 'Isian :attribute seharusnya lebih dari atau sama dengan :value karakter.',
        'array' => 'Isian :attribute seharusnya sama dengan :value items atau lebih.',
    ],
    ...
    'uuid' => 'The :attribute harus berupa valid UUID.',
