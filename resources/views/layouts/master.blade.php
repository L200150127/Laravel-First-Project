<!DOCTYPE html> {{-- This is a starter template page. Use this page to start your new project from scratch. This page gets rid of all links
and provides the needed markup only. --}}
...
<body class="hold-transition sidebar-mini">
  <div class="wrapper" id="app">
    ...
    </a> {{-- Menambahkan credit --}} {{--
      <div>Icons made by <a href="https://www.flaticon.com/authors/smashicons" title="User">User</a> from <a href="https://www.flaticon.com/"
          ...
          target="_blank">CC 3.0 BY</a></div> --}} {{-- Sidebar --}}
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <li class="nav-item">
                <router-link to="#" class="nav-link">
                  <i class=" nav-icon fas fa-chalkboard-teacher text-teal"></i>
                  <p>
                    Data Guru
                  </p>
                </router-link>
              ...
              <li class="nav-item">
                <router-link to="#" class="nav-link">
                  <i class=" nav-icon fas fa-book-reader text-orange"></i>
                  <p>
                    Data Siswa
                  </p>
                </router-link>
              ...
              <li class="nav-item">
                <router-link to="#" class="nav-link">
                  <i class=" nav-icon fas fa-archive text-cyan"></i>
                  <p>
                    File Manajer
                  </p>
                </router-link>
  ...
  {{-- ./wrapper --}} {{-- REQUIRED SCRIPTS --}} {{-- Compiled Script --}}
